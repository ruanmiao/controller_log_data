...
file_error_1 = 'mModel_mController/to_test/count_stretching_violation.txt';
file_error_2 = 'mModel_mController/to_test/count_stretching_violation.txt';
file_error_3 = 'mModel_mController/to_test/count_stretching_violation.txt';
...
fig_path_dm = 'mModel_mController/to_test/count_stretching_violation.pdf';
fig_path_dd_wo = 'mModel_mController/to_test/count_stretching_violation.pdf';
fig_path_dd_w = 'mModel_mController/to_test/count_stretching_violation.pdf';
fig_path_1 = 'mModel_mController/to_test/count_stretching_violation.pdf';
fig_path_2 = 'mModel_mController/to_test/count_stretching_violation.pdf';
fig_path_3 = 'mModel_mController/to_test/count_stretching_violation.pdf';

fig_path_realtime_integral_stretching = 'mModel_mController/to_test/count_stretching_violation.pdf';
...
%show_ind = 1:300;
time_mean_mm = mean(stretching_factor_mm(show_ind));
time_mean_dm = mean(stretching_factor_dm(show_ind));
time_mean_dd = mean(stretching_factor_dd_wo(show_ind));

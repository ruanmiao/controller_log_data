...
%%%%%%%%%%% Error Analysis %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
file_error_dm = 'mModel_mController/stretching/DM/realtime_stretching_factor.txt';
file_error_dd_wo = 'mModel_mController/stretching/DD/realtime_stretching_factor.txt';
file_error_dd_w = 'mModel_mController/stretching/DD/realtime_stretching_factor.txt';
file_error_1 = 'mModel_mController/stretching/MM/realtime_stretching_factor.txt';
file_error_2 = 'mModel_mController/stretching/MM/realtime_stretching_factor.txt';
file_error_3 = 'mModel_mController/stretching/MM/realtime_stretching_factor.txt';
